 ...
 * @author Jared Hawley
 * @since 2023.03.22
 * @description This program will play a basketball game
 * where the user will type in player names and stats
 */
public class BB_Stats_App {
    ...
    private void displayGameStatus() {
    	...
    	team1.getPlayer1().displayFullStat();
    	System.out.println();
    	
    	team1.getPlayer2().displayFullStat();
    	System.out.println();
    	
    	team2.getPlayer1().displayFullStat();
    	System.out.println();
    	
    	team2.getPlayer2().displayFullStat();
    	System.out.println();
